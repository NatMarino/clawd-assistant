...
// The host only ever asks for the names on the left, so drawing one is a
// matter of adding it to sprites.js (or sprites-cli.js): a real clip there
// wins over its placeholder here, per skin.
...
const STYLES = {
  app: {
    name: 'app', clips: withPlaceholders(CLIPS), spriteW: SPRITE_W, spriteH: SPRITE_H, cell: 8, ground: 148, snap: 'int',
  ...
  cli: {
    name: 'cli', clips: withPlaceholders(CLIPS_CLI), spriteW: CLI_W, spriteH: CLI_H, cell: 1.5, ground: 146, snap: 'edge',
