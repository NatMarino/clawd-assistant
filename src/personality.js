...
const LINES = {
  sweet: {
    ...
    sessAsk: ['Claude needs you in {project}!', 'Psst, {project} is waiting for you.', 'Your {project} session has a question!'],
    sessDone: ['{project} is done!', 'All done in {project}!', 'Claude finished up in {project}.'],
    sessError: ['Uh oh, {project} hit a snag.', 'Something went wrong in {project}.'],
    hooksOn: ['Yay! Now I can see your coding sessions.', 'Connected! I’ll watch your sessions for you.'],
  ...
  silly: {
    ...
    sessDone: ['Ding ding! {project} is done!', '{project}: done and dusted!'],
  ...
  serious: {
    ...
    sessAsk: ['{project} needs your input.', 'Input needed in {project}.'],
    sessDone: ['{project} has finished.', 'Done: {project}.'],
  ...
  dramatic: {
    ...
    sessAsk: ['{project} CALLS for you!', 'URGENT! Well, sort of. {project} needs you!'],
    sessDone: ['{project} is COMPLETE!', 'Victory in {project}!'],
